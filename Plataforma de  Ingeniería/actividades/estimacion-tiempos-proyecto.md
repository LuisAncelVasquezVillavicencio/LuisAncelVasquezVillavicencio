...
| 5.2. Usuarios                                | 1 semana        |
| 5.3. Permisos                                | 1 semana        |
| 5.4. Roles                                   | 0.5 semana      |
| 5.5. Flujos de Aprobación                    | 1.5 semanas     |
| 5.6. Scripts Shell (incluye formularios parametrizados) | 2.5 semanas      |
| 5.7. Ayuda y Documentación                   | 0.5 semana      |
| 6. Pruebas Generales y Validación            | 1.5 semanas     |
| 7. Despliegue y Puesta en Producción         | 1 semana        |
| 8. Capacitación, Documentación y Mantenimiento| 1 semana        |

---

## Cronograma Visual por Semanas

| Actividad / Semana                                      | S1 | S2 | S3 | S4 | S5 | S6 | S7 | S8 | S9 | S10 | S11 | S12 |
|---------------------------------------------------------|----|----|----|----|----|----|----|----|----|-----|-----|-----|
...
| Scripts Shell (incluye formularios parametrizados)       |    |    |    |    |    |    | X  | X  | X   |     |     |     |
| Ayuda y Documentación                                   |    |    |    |    |    |    |    |    |  X  |     |     |     |
| Pruebas Generales y Validación                          |    |    |    |    |    |    |    |    |    |  X  |  X  |     |
| Despliegue y Puesta en Producción                       |    |    |    |    |    |    |    |    |    |     |     |  X  |
| Capacitación, Documentación y Mantenimiento             |    |    |    |    |    |    |    |    |    |     |     |  X  |
...
- **Mínimo realista:** 11-12 semanas (alrededor de 3 meses)
- **Con holgura y validaciones:** 14-16 semanas (3.5-4 meses)
